...
//     }
//     try {
//         delete (window as any)['starknet-civia'];
//         // set read only property to window
//         Object.defineProperty(window, 'starknet-civia', {
//             value: starknetWindowObject,
//             writable: false
//         });
//     } catch {
...
//     }
//     try {
//         (window as any)['starknet-civia'] = starknetWindowObject;
//     } catch {
//     // ignore
//     }
// }
...
import * as inPage from '@argentx/packages/extension/src/inpage/index';
